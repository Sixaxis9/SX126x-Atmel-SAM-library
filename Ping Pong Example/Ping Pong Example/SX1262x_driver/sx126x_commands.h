...
/*!
    ...
    */
uint8_t SX126x_GetPayload( uint8_t *payload, uint8_t *size, uint8_t offset );
...
/*!
    ...
    */
void SX126x_WriteCommand( RadioCommands_t opcode, uint8_t *buffer, uint16_t size );
...
/*!
    ...
    * \param [in]  size          Command parameters byte array size
    */
void SX126x_ReadCommand( RadioCommands_t opcode, uint8_t *buffer, uint16_t size );
...
/*!
    ...
    */
void SX126x_WriteRegister( uint16_t address, uint8_t *buffer, uint16_t size );
...
/*!
    ...
    */
void SX126x_WriteReg( uint16_t address, uint8_t value );
...
/*!
    ...
    */
void SX126x_ReadRegister( uint16_t address, uint8_t *buffer, uint16_t size );
...
/*!
    ...
    */
uint8_t SX126x_ReadReg( uint16_t address );
...
/*!
    ...
    * \param [in]  size          Buffer size
    */
void SX126x_ReadBuffer( uint8_t offset, uint8_t *buffer, uint8_t size );
...
/*!
    ...
    */
uint8_t SX126x_GetDioStatus( void );
...
/*!
    ...
    */
uint8_t SX126x_GetDeviceType( void );
...
/*!
    ...
    *              0: 915 MHz
    */
uint8_t SX126x_GetFreqSelect( void );

/*!
    * \brief RF Switch power on
    */
void SX126x_AntSwOn( void );

/*!
    * \brief RF Switch power off
    */
void SX126x_AntSwOff( void );
